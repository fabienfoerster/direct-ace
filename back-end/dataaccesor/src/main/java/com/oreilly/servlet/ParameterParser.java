...
public class ParameterParser {
   ...
   * @exception java.io.UnsupportedEncodingException if the charset is not supported
   * on this sytem
   */
   ...
   * @exception com.oreilly.servlet.ParameterNotFoundException if the parameter was not found
